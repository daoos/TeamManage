...
function fPopCalendar(evt,popCtrl,dateCtrl){
	...
	var point=fGetXY(popCtrl);with($("calendardiv").style){
		left=point.x+"px";
            ...
            <ul class="hornav blogmenu">
               ...
               <!--  <li><a href="published.jsp">分享</a></li>
                ...
                <li><a href="trash.jsp">日程</a></li> -->
                    ...
                    <form class="stdform" action="AddSchedule" method="post">
                  <%--   <input name="projectId" type="hidden" value="<s:property value="projectId"/>" /> --%>
                       <p>
                        ...
                        <p>
                        	<label>日程地点</label>
                            <span class="field"><input type="text"  name="place" class="smallinput" /></span>
                        </p>
                        <label >开始日期：</label><input name="startTime" type="date" value="" onClick="fPopCalendar(event,this,this)" onFocus="this.select()" readonly="readonly" />
                        <p>
                         </p>
                        <label >截止日期：</label><input name="endTime" type="date" value="" onClick="fPopCalendar(event,this,this)" onFocus="this.select()" readonly="readonly" />
